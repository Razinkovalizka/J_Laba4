...
public class Main {
     ...
     */
    public static void input(ArrayList<Person> people, final String csvFilePath, final char separator) {
        try (InputStream in = Main.class.getClassLoader().getResourceAsStream(csvFilePath);
            ...
            while ((nextLine = reader.readNext()) != null) {
                people.addLast(new Person(nextLine));
            }
    ...
    public static void main(String[] args) {
        ...
        input(people, "foreign_names.csv", ';');
